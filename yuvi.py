...
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•""")
                ...
                if key in [""]:
                    ...
                    print('[Ã—] Choose Correct Option');time.sleep(1)
        else:
                print(logo)
                print(f'[â€¢] Your Key Not Registerd...')
                
                print(f'[â€¢] This Tools Only For Paid Users \n[â€¢] Free Users Saty A Way')
                os.system('espeak -a 300 "well,come to, AV3SH SH4IKH L3G3ND H3R3 KING OWNER , tools"')
                print(f'[â€¢] Your Key : '+key)
                os.system("am start https://wa.me/+919919583034?text="+key)
                input(f'[] Press Enter For Approve ')    
                whatsapp = "+919919583034"
                url_wa = "https://api.whatsapp.com/send?phone="+whatsapp+"&text="
                tks = ("Hello AV3SH SH4IKH sir , I Need To Buy Your Paid Tools Please Approve My Key :)\n\n Key :- "+key)
